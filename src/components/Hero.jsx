        ...
        <header className="relative bg-[#0b070f]">
            <div className="absolute inset-x-0 -top-48 -bottom-14 overflow-hidden">
                <Image
                    ...
                    unoptimized
                />
                <div className="absolute inset-x-0 top-0 h-40 bg-gradient-to-b from-[#141217]" />
                <div className="absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-[#141217]" />
            </div>
                ...
                <div className="pt-16 lg:col-span-7 lg:pt-0 lg:pl-16 xl:pl-24 z-50">
                    <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
                        <h1 className="text-3xl font-extrabold text-slate-100 sm:text-5xl">
                            Accédez à plusieurs années de travail, de réflexion, et de recherche !
                        </h1>
